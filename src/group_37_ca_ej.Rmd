...
As shown in Figure 1, there is a general downhill trend between the percent of the population that is White and the CalEnviroScreen pollution burden score meaning that on average as the percentage of the population that is White increses the pollution burden score decreases. 
